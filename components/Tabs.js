...
export default class Tabs extends React.Component {
    ...
    renderItem = (item) => {
        ...
        const textColor = this.animatedValue.interpolate({
            inputRange: [0, 1],
            outputRange: [themeBase.COLORS.BLACK, isActive ? themeBase.COLORS.WHITE : themeBase.COLORS.BLACK],
            extrapolate: 'clamp',
        });

        const containerStyles = [
            styles.titleContainer,
            !isActive && { backgroundColor: themeBase.COLORS.SECONDARY },
...
const styles = StyleSheet.create({
    ...
    titleContainer: {
        alignItems: 'center',
        backgroundColor: themeBase.COLORS.ACTIVE,
        borderRadius: 4,
        marginRight: 9,
    },
    containerShadow: {
